...
async function main() {
  ...
  console.log("Trying to upsert for santri", santri.namaLengkap);
  console.log("poinTahapId:", firstPoint.id, "nominalHarus:", firstPoint.nominal);

  // Let's pass a huge input
  const testNominal = firstPoint.nominal + 100000;
  console.log("Input nominal (surplus 100k):", testNominal);
