              ...
              return (
                <tr key={santri.id} className="border-b border-primary-light/10 dark:border-gray-700 hover:bg-[#faf9f5] dark:bg-gray-800 transition-colors group">
                  ...
                  {tahaps.map(tahap => {
                    ...
                    return (
                      <td key={tahap.id} className={`p-2 border-r border-primary-light/10 dark:border-gray-700 text-center cursor-pointer transition-colors ${record?.selesai ? 'bg-success/5 hover:bg-success/10' : (!tahap.isActive ? 'bg-gray-50 dark:bg-gray-800' : 'bg-white dark:bg-gray-900 hover:bg-gray-50 dark:bg-gray-800')}`}>
                        {record ? (
